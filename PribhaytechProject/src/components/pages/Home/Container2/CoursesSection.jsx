            ...
            >
              ...
              <div className="space-y-6">
                ...
                {/* <div className="flex items-center">
                  <span className="text-2xl font-bold text-[#b42638]">{course.discountedPrice}</span>
                  <span className="ml-3 text-sm text-gray-400 line-through">{course.originalPrice}</span>
                </div> */}

                <div className="flex flex-col space-y-3">
                  <button className="w-full py-3 bg-[#b42638] text-white font-medium rounded-lg hover:bg-[#8a1a2a] transition-colors duration-300 flex items-center justify-center">
                    <span>Read More</span>
                    <svg 
